...
class UserSeedTable extends Seeder
{
    ...
    public function run()
    {
        DB::table('users')->insert([
            ['id' => 4, 'name' => 'Collette Gavan', 'email' => 'gavanc@edgehill.ac.uk', 'role_id' => 2, 'password' => '$2y$10$m/C7Bkdp9Lo7TgBFS1R5ou/oXxf5K64U8ImQK6GN6v7PrSqkRcfaC', 'student_no' => null, 'supervisor_id' => null],
            ['id' => 3, 'name' => 'Mark Hall', 'email' => 'hallmark@edgehill.ac.uk', 'role_id' => 2, 'password' => '$2y$10$m/C7Bkdp9Lo7TgBFS1R5ou/oXxf5K64U8ImQK6GN6v7PrSqkRcfaC', 'student_no' => null, 'supervisor_id' => null],
